...
export const metadata: Metadata = {
  title: `For Site Owners - Improve Your ${BRAND.name} Score | UndeadList`,
  description: `How to improve your trust score on ${BRAND.name}. Tips for site owners to build credibility, earn the verified badge, and build trust with indie developers. By UndeadList.`,
  keywords: ['improve trust score', 'website trust badge', 'trust scan verified', 'build website credibility', 'site owner tips', 'undeadlist', 'indie developer trust'],
};
